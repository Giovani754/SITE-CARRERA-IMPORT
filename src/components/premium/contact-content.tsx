        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              {/* Element 2: Intro text */}
              <motion.p
                initial={{ opacity: 0, x: -32 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.65, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
                className="text-white/45 text-[15px] leading-[1.8] font-sans font-light max-w-lg"
              >
            ...
            <div className="space-y-8">
              {/* Element 6: Business Hours card */}
              <motion.div
                initial={{ opacity: 0, x: -32 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.65, delay: 0.6, ease: [0.16, 1, 0.3, 1] }}
                className="p-8 border border-white/5 bg-[#080808] rounded-sm"
              >
              ...
              <motion.div
                ...
                className="w-full aspect-video border border-white/10 rounded-sm overflow-hidden relative group"
              >
                <iframe
          ...
          {/* Contact Form Area */}
          {/* Element 7: Contact Form Card */}
          <motion.div
            initial={{ opacity: 0, x: 24 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7, delay: 0.4, ease: [0.16, 1, 0.3, 1] }}
            className="bg-[#080808] border border-white/5 p-10 lg:p-14 rounded-sm h-fit"
          >
            ...
            <p className="text-white/30 text-xs mb-8 font-light">
              Preencha seus dados ou entre em contato diretamente via WhatsApp para um atendimento imedias.
            </p>
            <div className="space-y-8">
              {/* Form fields (visual only now) */}
