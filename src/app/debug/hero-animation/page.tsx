...
export default function HeroAnimationDebugPage() {
  ...
  const config = getAnimationConfig("hero", false); // Force desktop for debug
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#030303] text-white font-sans p-8">
      <div className="mb-8 border-b border-white/10 pb-4">
        <h1 className="text-2xl font-serif italic text-brand-gold mb-2">Hero Animation Debug</h1>
        <p className="text-white/40 text-sm">Testing: public/animations/hero/desktop/</p>
      </div>
        ...
        <div className="bg-white/5 border border-white/10 p-6 rounded-sm space-y-6 h-fit">
          ...
          <div className="space-y-4 pt-4 border-t border-white/10">
            ...
            <div className="space-y-2 text-[10px] break-all font-mono">
              <div>
                <span className="text-white/20 block mb-1 uppercase tracking-tighter">First Path:</span>
                <span className="text-white/60">{firstPath}</span>
              </div>
              <div>
                <span className="text-white/20 block mb-1 uppercase tracking-tighter">Last Path:</span>
        ...
        >
          {status === "loading" && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10 bg-black">
              ...
              <span className="text-[10px] uppercase tracking-[0.4em] text-white/20">Carregando Sequência...</span>
            </div>
          )}
